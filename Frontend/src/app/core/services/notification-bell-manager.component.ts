// notification-bell-manager.component.ts
...
@Component({
  selector: 'app-notification-bell-manager',
  standalone: true,
...
export class NotificationBellManagerComponent implements OnInit, OnDestroy {
  isOpen = false;
  ...
  ngOnInit(): void {
    console.log('=== NotificationBellManagerComponent INIT ===');
    this.loadNotifications();
    this.loadUnreadCount();
    
    this.subscriptions.push(
      this.notificationWS.notifications$.subscribe((notification: Notification) => {
        console.log('Nouvelle notification manager:', notification);
    ...
    this.subscriptions.push(
      this.notificationWS.unreadCount$.subscribe((count: number) => {
        console.log('Nouveau compteur manager:', count);
